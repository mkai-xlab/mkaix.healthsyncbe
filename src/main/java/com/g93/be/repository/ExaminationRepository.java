...
public interface ExaminationRepository extends JpaRepository<Examination, Long> {
        ...
        /**
         * Đếm số lượng bệnh nhân được chẩn đoán với mỗi mức độ (Grade)
         * Chỉ tính lần gần nhất (latest) của mỗi bệnh nhân
         */
        ...
        /**
         * Lấy danh sách các ngày có dữ liệu từ ngày startDate trở đi
         * chỉ tính lần gần nhất (latest) của mỗi bệnh nhân
         */
