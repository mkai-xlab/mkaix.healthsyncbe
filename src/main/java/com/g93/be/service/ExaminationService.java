...
import com.g93.be.dto.DailyStatDto;
...
public interface ExaminationService {
    ...
    List<DailyStatDto> getDailyExaminationsInLast7Days(Long userId, Boolean isPersonal);

    PageResponse<ExaminationDto> getExaminationsByStatus(ExaminationStatus status, String username, Boolean isPersonal,
            Pageable pageable);

    PageResponse<ExaminationDto> getExaminationsByGrade(Integer grade, String username, Boolean isPersonal,
            Pageable pageable);

    List<PatientGradeStatsDto> getPatientGradeStatistics(String username, Boolean isPersonal);

    PageResponse<ExaminationDto> getExaminationsSortedByStudyDate(String direction, String username, Boolean isPersonal,
            Pageable pageable);

    PageResponse<ExaminationDto> getExaminationsSortedByUploadDate(String direction, String username,
            Boolean isPersonal, Pageable pageable);

    PageResponse<ExaminationDto> getExaminationsFilteredByStudyDate(LocalDate date, String username, Boolean isPersonal,
            Pageable pageable);

    PageResponse<ExaminationDto> getExaminationsFilteredByUploadDate(LocalDate date, String username,
            Boolean isPersonal, Pageable pageable);
