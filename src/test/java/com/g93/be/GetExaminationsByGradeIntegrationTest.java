...
@SpringBootTest
@Transactional
public class GetExaminationsByGradeIntegrationTest {
    ...
    void setUp() throws Exception {
        ...
        // doctor1 has 2 Grade 3, 1 Grade 4
        createExam(patient, doctor1, 3);
        createExam(patient, doctor1, 3);
        createExam(patient, doctor1, 4);

        // doctor2 has 1 Grade 3, 2 Grade 4
        createExam(patient, doctor2, 3);
        createExam(patient, doctor2, 4);
        createExam(patient, doctor2, 4);
    }
    ...
    private Examination createExam(Patient patient, Doctor doctor, Integer grade) {
        ...
        exam.setMaxPredictedGrade(grade);
        return examinationRepository.save(exam);
    }

    @Test
    void testGetExaminationsByGrade_AsDoctor1_Grade3() throws Exception {
        mockMvc.perform(get("/examinations/grade")
                .param("grade", "3")
    ...
    @Test
    void testGetExaminationsByGrade_AsDoctor1_Grade4() throws Exception {
        mockMvc.perform(get("/examinations/grade")
                .param("grade", "4")
                .header("Authorization", "Bearer " + doctor1Token))
                .andExpect(status().isOk())
    ...
    @Test
    void testGetExaminationsByGrade_AsHeadOfDepartment_Grade3() throws Exception {
        // Head of department should see exams from all doctors (2 from doctor1 + 1 from doctor2 = 3)
        mockMvc.perform(get("/examinations/grade")
                .param("grade", "3")
    ...
    @Test
    void testGetExaminationsByGrade_AsHeadOfDepartment_Grade4() throws Exception {
        // Head of department should see exams from all doctors (1 from doctor1 + 2 from doctor2 = 3)
        mockMvc.perform(get("/examinations/grade")
                .param("grade", "4")
                .header("Authorization", "Bearer " + headOfDepartmentToken))
                .andExpect(status().isOk())
    ...
    @Test
    void testGetExaminationsByGrade_Unauthenticated() throws Exception {
        mockMvc.perform(get("/examinations/grade")
                .param("grade", "3"))
